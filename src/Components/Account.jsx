...
function Account() {
  ...
  if (!isAuthenticated) {
    return (<>
      <div style={styles.account} onClick={() => {authenticate({ provider: "metamask" });console.log(isAuthenticated)}}>
        <p style={styles.text}>Authenticate</p>
      </div><button onClick={() => signup('username', 'password', 'email@gmail.com')}>Sign up</button></>
    );
  }
